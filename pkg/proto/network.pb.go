...
func (x *GraphResponse) GetMessageData() *MessageData {
	if x != nil {
		return x.MessageData
	}
	return nil
...
func (x *GraphResponse) GetRound() int32 {
	if x != nil {
		return x.Round
	}
	return 0
...
func (x *GraphResponse) GetAccepted() bool {
	if x != nil {
		return x.Accepted
	}
	return false
